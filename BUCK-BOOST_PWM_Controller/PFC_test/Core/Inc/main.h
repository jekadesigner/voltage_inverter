...
#define TIM_INT_Pin GPIO_PIN_10
#define TIM_INT_GPIO_Port GPIOB
#define LED_5_Pin GPIO_PIN_11
#define LED_5_GPIO_Port GPIOB
#define Phaze_A_Pin GPIO_PIN_12
#define Phaze_A_GPIO_Port GPIOB
#define Phaze_A_EXTI_IRQn EXTI15_10_IRQn
#define Phaze_B_Pin GPIO_PIN_13
#define Phaze_B_GPIO_Port GPIOB
#define Phaze_B_EXTI_IRQn EXTI15_10_IRQn
#define Phaze_C_Pin GPIO_PIN_14
#define Phaze_C_GPIO_Port GPIOB
#define Phaze_C_EXTI_IRQn EXTI15_10_IRQn
#define INT_UI_Pin GPIO_PIN_15
#define INT_UI_GPIO_Port GPIOB
#define INT_UI_EXTI_IRQn EXTI15_10_IRQn
